...
#include <engine/renderers/arrow2_rend.h>
...
void init() {
    ...
    darr_t<arrow2_point_t>& points = arrow2_rdata.points;
    darr_new(points, 16);

    arrow2_point_t arrow_point;
    ...
    arrow2_rdata_build(arrow2_rdata);
}

void shut() {
    sky_rend_shut();

    arrow2_rdata_clear(arrow2_rdata);
    arrow2_rend_shut();
}
...
void render() {
    ...
    arrow2_rend_render(arrow2_rdata, cam);
}
