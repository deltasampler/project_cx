...
#include <engine/renderers/line3_rend.h>
...
void init() {
    ...
    darr_t<line3_point_t>& points = line3_rdata.points;
    darr_new(points, 16);

    line3_point_t arrow_point;
    ...
    line3_rdata_build(line3_rdata);
}

void shut() {
    sky_rend_shut();

    line3_rdata_clear(line3_rdata);
    line3_rend_shut();
}
...
void render() {
    ...
    line3_rend_render(line3_rdata, cam);
}
