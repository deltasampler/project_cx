...
void line3_rdata_build(line3_rdata_t& rdata) {
    ...
    glBufferData(GL_ARRAY_BUFFER, rdata.points.len * sizeof(line3_point_t), rdata.points.data, GL_DYNAMIC_DRAW);

    s32 offset = 0;
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(line3_point_t), (void*)(offset));
    glEnableVertexAttribArray(0);

    offset += sizeof(fvec3_t);
    glVertexAttribPointer(1, 1, GL_FLOAT, GL_FALSE, sizeof(line3_point_t), (void*)(offset));
    glEnableVertexAttribArray(1);

    offset += sizeof(f32);
    glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(line3_point_t), (void*)(offset));
...
void line3_rend_init() {
    program.handle = program_load(MODULE_PATH"assets/shaders/line3_rend.glsl");
