...
void arrow2_rdata_build(arrow2_rdata_t& rdata) {
    ...
    glBufferData(GL_ARRAY_BUFFER, rdata.points.len * sizeof(arrow2_point_t), rdata.points.data, GL_DYNAMIC_DRAW);

    s32 offset = 0;
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(arrow2_point_t), (void*)(offset));
    glEnableVertexAttribArray(0);

    offset += sizeof(fvec3_t);
    glVertexAttribPointer(1, 1, GL_FLOAT, GL_FALSE, sizeof(arrow2_point_t), (void*)(offset));
    glEnableVertexAttribArray(1);

    offset += sizeof(f32);
    glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(arrow2_point_t), (void*)(offset));
    glEnableVertexAttribArray(2);

    offset += sizeof(fvec3_t);
    glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(arrow2_point_t), (void*)(offset));
...
void arrow2_rend_init() {
    program.handle = program_load(MODULE_PATH"assets/shaders/arrow2_rend.glsl");
